const svg = (paths: string, extraClasses = ""): string =>
	`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-5 ${extraClasses}">${paths}</svg>`;

const svgOutline = (paths: string, extraClasses = ""): string =>
	`<svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" viewBox="0 0 24 24" class="size-5 ${extraClasses}">${paths}</svg>`;
...
export const Icons = {
	...
	timeslots: svgOutline(Paths.timeslots),
	users: svgOutline(Paths.users),
	arrowBack: svgOutline(Paths.arrowBack),
	plus: svgOutline(Paths.plus),
};
...
export const SocialIcons = {
	...
	google: `<svg class="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
		<title>Google</title>
